<%-- 
    Document   : ServiciosPagado
    Created on : 25-jul-2018, 11:19:12
    Author     : Veron
--%>
...
<html>
    ...
    <%}%><br>
    <center><h4><b>Elija el servicio que desea reservar</b></h4></center>
...
<tbody>
    <s:iterator value="Servicio">
        <tr>
            ...
            <td><a href="<s:url action="ReservarServicio"/>?servi.cod=<s:property value="cod"/>"><img src="Images/reservar.png" alt="portada" width="60" height="40"></a>   
        </tr>
    </s:iterator>
</tbody>
</table>  
