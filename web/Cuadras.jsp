<%-- 
    Document   : Cuadras
    Created on : 16-jul-2018, 10:42:52
    Author     : Veron
--%>
...
<html>
    ...
    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <center><h4><b>Cuadras</b></h4></center>
        <thead>
            <tr>
                <th><center>Numero</center></th>
    <th><center>Limpio</center></th>
<th><center>Comida</center></th>
<th><center>Enlaces</center></th>
</tr>
</thead>
<tbody>
    <s:iterator value="Cuadra">
        <tr>
            <td><s:property value="numero"/></td>
            <td><s:property value="limpio"/></td>
            <td><s:property value="comida"/></td>
            <td>Eliminar
            <a href="<s:url action="BorrarCuadra"/>?cuad.numero=<s:property value="numero"/>"><img src="Images/Borrar.png" alt="portada" width="40" height="40"></a>  
            <br>Modificar
            <a href="<s:url action="MostrarEditarCuadra"/>?cuad.numero=<s:property value="numero"/>"><img src="Images/Modificar.png" alt="portada" width="40" height="40"></a></td> 
        </tr>
    </s:iterator>
</tbody>
</table>
<center><div id="boton">
        <center><b><a href="./RegistroCuadras.jsp"><img src="Images/Nuevo.png" alt="nuevo" width="40" height="40"><br>Nueva Cuadra</a></b></div></center>
    </div></center> 
<div id="footer">
