<%-- 
    Document   : RegistroClases
    Created on : 10-jul-2018, 13:59:59
    Author     : Veron
--%>
...
<html>
    ...
    <s:form action="AltaClases" method="post" id="formulario">
        <center><legend style="font-size: 30px;"><b>Datos de la clase</b></legend></center>
            <s:textfield id="campoForm" placeholder="Codigo" name="clas.id.cod" required="required"/>
            <s:select id="campoForm1" label="Disciplina" name="clas.disciplina" 
                      list="{'Doma Clasica','Doma Vaquera','Doma Natural','Volteo','Salto','Infantil'}" required="required"/>
            <s:textfield id="campoForm2" placeholder="Dia de la semana" name="clas.id.diaSemana" required="required"/>
            <s:textfield id="campoForm3" placeholder="Hora" name="clas.id.hora" required="required"/>
            <s:textfield id="campoForm4" placeholder="Pista" name="clas.pista" required="required"/>
            <s:textfield id="campoForm5" placeholder="Profesor" name="clas.profesor" required="required"/>
