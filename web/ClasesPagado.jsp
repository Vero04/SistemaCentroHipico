...
<html>
    ...
    <center><h5><b>Has iniciado sesion como <%= session.getAttribute("usuario")%></b></h5></center>
                <%}%>
        <br>
    <center><h4><b>Elija que clase desea reservar</b></h4></center>
...
<tbody>
    <s:iterator value="Clase">
        <tr>
            ...
            <td>15€</td>
            <td><a href="<s:url action="ReservarClase"/>?clas.id.cod=<s:property value="id.cod"/>"><img src="Images/reservar.png" alt="portada" width="60" height="40"></a>   
        </tr>
    </s:iterator>
</tbody>
</table>  
