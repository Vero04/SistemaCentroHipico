<%-- 
    Document   : ReservasServiciosCliente
    Created on : 23-jul-2018, 16:26:58
    Author     : Veron
--%>
...
<html>
    ...
    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <center><h4><b>Servicios reservados</b></h4></center>
        <thead>
            <tr>
...
<tbody>
    <s:iterator value="ReservaServicio">
        <tr>
            <td><s:property value="id.servicio"/></td>
