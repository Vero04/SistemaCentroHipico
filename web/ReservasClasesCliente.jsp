<%-- 
    Document   : ReservasClasesCliente
    Created on : 23-jul-2018, 15:54:10
    Author     : Veron
--%>
...
<html>
    ...
    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <center><h4><b>Clases a las que asiste</b></h4></center>
        <thead>
            <tr>
                <th><center>Codigo clase</center></th>
    <th><center>Dia de la semana</center></th>
<th><center>Hora</center></th>
<th><center>DNI del asistente</center></th>
</tr>
</thead>
<tbody>
    <s:iterator value="ReservaClase">
        <tr>
            <td><s:property value="id.codigo"/></td>
            <td><s:property value="id.diaSemana"/></td>
            <td><s:property value="id.hora"/></td>
            <td><s:property value="id.asistente"/></td>
        </tr>
    </s:iterator>
</tbody>
</table>
<center><br><a href="<s:url action="Clases"/>"><img src="Images/FlechaAtras.PNG" alt="Atras" width="40" height="40"></a></center> &nbsp;&nbsp;&nbsp;&nbsp;
<br><br>                
<div id="footer">
