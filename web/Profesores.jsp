<%-- 
    Document   : Profesores
    Created on : 20-jul-2018, 13:41:18
    Author     : Veron
--%>
...
<html>
    ...
    <%}%><br>
    <center><h4><b>Profesores del centro hípico</b></h4></center>
    <div class="row">
        <s:iterator value="Trabajador">
            <div class="col-lg-4"> <img src="<s:property value="imagen"/>"alt="portada" width="150" height="150"><br><h5><b><s:property value="nombre"/></b></h5></div>
                    </s:iterator>
    </div>
    <br>
    <div id="footer">
