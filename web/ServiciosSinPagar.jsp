<%-- 
    Document   : Servicios
    Created on : 20-jul-2018, 18:15:47
    Author     : Veron
--%>
...
<html>
    ...
    <%}%><br>
    <center><h4><b>Servicios del centro hípico</b></h4></center>
...
<center><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
        ...
        <input type="hidden" name="hosted_button_id" value="9LFNUQEVUNDZC">
...
<center><div id="boton">
        <center><b><a href="<s:url action="ServiciosReservadosCliente"/>?cli.id.usuario=<%= session.getAttribute("usuario")%>"><img src="Images/reservado.png" alt="nuevo" width="40" height="40"><br>Servicios Reservados</a></b></center>
    </div></center>    
<div id="footer">
