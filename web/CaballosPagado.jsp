<%-- 
    Document   : CaballoPagado
    Created on : 25-jul-2018, 11:01:55
    Author     : Veron
--%>
...
<html>
    ...
    <%}%><br>
    <center><h4>Elija el caballo que desea reservar</h4></center>
    <div class="row" style="border: 4px; border-color: #202326;">
        <s:iterator value="Caballo">
            <div class="col-lg-4"> <img src="<s:property value="imagen"/>"alt="portada" width="150" height="150"><br><h5><b><s:property value="nombre"/></b></h5>
                <h5><b><s:property value="raza"/></b></h5><h5><b><s:property value="altura"/></b></h5><h5><b> Venta:<s:property value="venta"/> </b></h5><br><a href="<s:url action="ReservarCaballo"/>?cabal.cod=<s:property value="cod"/>"><img src="Images/reservar.png" alt="portada" width="60" height="40"></a></div>
                </s:iterator>
    </div>
    <div id="footer">
