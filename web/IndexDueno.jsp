<%-- 
    Document   : IndexDueno
    Created on : 04-jun-2018, 19:48:17
    Author     : Veron
--%>
...
<html>
    ...
    <div id="video">
        <div id="video1">
            <center><h2><b>Plano general del establo</b></h2></center>
            <center><video src="Images/Videos/cuadras.mp4" autoplay loop style="width: 900px; max-height: 600px;"></video></center><!--Referencia: https://www.facebook.com/fundacionrealescuelaandaluzadelarteecuestre/videos/10155782966993182/-->
        </div>
        <div id="video2">
            <center><h2><b>Campo</b></h2></center>
            <center><video src="Images/Videos/Campo.mp4" autoplay loop style="width: 900px; max-height: 600px;"></video></center> <!--Referencia: https://www.youtube.com/watch?v=5VqOHNCs57I-->
        </div>
        <div id="video3">
            <center><h2><b>Pista 1</b></h2></center>
            <center><video src="Images/Videos/Pista1.mp4" autoplay loop style="width: 1100px; max-height: 600px;"></video></center><!--Referencia: https://www.facebook.com/fundacionrealescuelaandaluzadelarteecuestre/videos/10154880956128182/-->
        </div>
        <div id="video4">
            <center><h2><b>Pista 2</b></h2></center>
            <center><video src="Images/Videos/VideoPrueba1.mp4" autoplay loop style="width: 900px; max-height: 600px;"></video></center>
        </div>
    </div>
    <div id="footer">
