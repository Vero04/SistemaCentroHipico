<%-- 
    ...
    Created on : 14-jul-2018, 19:27:18
    Author     : Veron
--%>
...
<html>
    ...
    <s:form action="AltaServicio" method="post" id="formulario">
        <center><legend style="font-size: 30px;"><b>Datos del servicio</b></legend></center>
            <s:textfield id="campoForm" placeholder="Codigo" name="servi.cod" required="required"/>
            <s:textfield id="campoForm1" placeholder="Nombre" name="servi.nombre" required="required"/>
            <s:textfield id="campoForm2" placeholder="Dias" name="servi.dias" required="required"/>
            <s:textfield id="campoForm3" placeholder="Precio" name="servi.precio" required="required"/>
            <s:submit id="enviar" label="Enviar" value="enviar"/>
        </s:form>
        <% if (session.getAttribute("usuario") != null) {%>
    <center><a href="<s:url action="ServiciosDueno"/>"><img src="Images/FlechaAtras.PNG" alt="Atras" width="40" height="40"></a> </center> &nbsp;&nbsp;&nbsp;&nbsp;
            <%}%>  
    <div id="footer">
