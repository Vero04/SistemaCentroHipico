<%-- 
    Document   : Monturas
    Created on : 26-jun-2018, 13:16:36
    Author     : Veron
--%>
...
<html>
    ...
    <br>
        <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <center><h4><b>Monturas</b></h4></center>
            <thead>
                <tr>
...
<s:iterator value="Montura">
    <tr>
        ...
        <td>Eliminar
            <a href="<s:url action="BorrarMontura"/>?mont.cod=<s:property value="cod"/>"><img src="Images/Borrar.png" alt="portada" width="40" height="40"></a>  
            <br>Modificar
            <a href="<s:url action="MostrarEditarMontura"/>?mont.cod=<s:property value="cod"/>"><img src="Images/Modificar.png" alt="portada" width="40" height="40"></a></td>    
    </tr>
</s:iterator>
</tbody>
</table>
<center><div id="boton">
        <center><b><a href="./RegistroMonturas.jsp"><img src="Images/Nuevo.png" alt="nuevo" width="40" height="40"><br>Nueva Montura</a></b></center>
    </div></center>   
