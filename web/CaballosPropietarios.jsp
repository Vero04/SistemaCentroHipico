<%-- 
    Document   : CaballosPropietarios.jsp
    Created on : 13-jul-2018, 19:32:07
    Author     : Veron
--%>
...
<html>
    ...
    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <center><h4><b>Propietarios de los caballos</b></h4></center>
        <thead>
            <tr>
                <th><center>Caballo</center></th>
    <th><center>Propietario</center></th>
<th><center>Enlaces</center></th>
</tr>
</thead>
<tbody>
    <s:iterator value="CaballoDueno">
        <tr>
            <td><s:property value="id.caballo"/></td>
            <td><s:property value="id.dueno"/></td>
            <td>Eliminar
            <a href="<s:url action="BorrarCaballoDueno"/>?cabalduen.cod=<s:property value="id.caballo"/>"><img src="Images/Borrar.png" alt="portada" width="40" height="40"></a></tr>
    </s:iterator>
</tbody>
</table>
<% if (session.getAttribute("usuario") != null) {%>
