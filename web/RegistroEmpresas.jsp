<%-- 
    Document   : RegistroEmpresas
    Created on : 14-jul-2018, 19:47:10
    Author     : Veron
--%>
...
<html>
    ...
    <br>
    <s:form action="AltaEmpresa" method="post" id="formulario">
        <center><legend style="font-size: 30px;"><b>Datos del servicio</b></legend></center>
            <s:textfield id="campoForm" placeholder="Codigo" name="empres.cod" required="required"/>
            <s:textfield id="campoForm1" placeholder="Nombre" name="empres.nombre" required="required"/>
            <s:textfield id="campoForm2" placeholder="Direccion" name="empres.direccion" required="required"/>
            <s:textfield id="campoForm3" placeholder="Código Postal" name="empres.codigoPostal" required="required"/>
            <s:textfield id="campoForm4" placeholder="Ciudad" name="empres.ciudad" required="required"/>
            <s:select id="campoForm5" label="Tipo de empresa" name="empres.tipoEmpresa" 
                      list="{'Suelo pistas','Alimentacion animales','Material equitacion','Material informatico','Recogida cadaveres','Material pistas'}" required="required"/>
            <s:textfield id="campoForm6" placeholder="Telefono" name="empres.telefono" required="required"/>
