<%-- 
    Document   : Clases
    Created on : 17-jun-2018, 18:53:29
    Author     : Veron
--%>
...
<tbody>
    <s:iterator value="Clase">
        <tr>
            ...
            <td>Eliminar
                <a href="<s:url action="BorrarClase"/>?clas.id.cod=<s:property value="id.cod"/>"><img src="Images/Borrar.png" alt="portada" width="40" height="40"></a>  
                <br>Modificar
                <a href="<s:url action="MostrarEditarClase"/>?clas.id.cod=<s:property value="id.cod"/>"><img src="Images/Modificar.png" alt="portada" width="40" height="40"></a></td> 
        </tr>
    </s:iterator>
</tbody>
</table>
<center><div id="boton">
        <center><div style="width: 25%; float: left;"><b><a href="./RegistroClases.jsp"><img src="Images/Nuevo.png" alt="nuevo" width="40" height="40"><br>Nueva Clase</a></b></div></center>
        <center><div style="width: 60%; float: right;"><b><a href="<s:url action="ReservasClases"/>"><img src="Images/reservado.png" alt="nuevo" width="40" height="40">Clases reservadas</a></b></div></center>
    </div></center>
<div id="footer">
