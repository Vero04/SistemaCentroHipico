<%-- 
    Document   : ReservasCaballosCliente
    Created on : 23-jul-2018, 16:20:49
    Author     : Veron
--%>
...
<html>
    ...
    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <center><h4><b>Caballos reservados</b></h4></center>
        <thead>
            <tr>
...
<tbody>
    <s:iterator value="ReservaCaballo">
        <tr>
...
<center><br><a href="<s:url action="Caballos"/>"><img src="Images/FlechaAtras.PNG" alt="Atras" width="40" height="40"></a></center> &nbsp;&nbsp;&nbsp;&nbsp;               
<div id="footer">
