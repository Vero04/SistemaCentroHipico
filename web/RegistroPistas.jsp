<%-- 
    Document   : RegistroPistas
    Created on : 14-jul-2018, 20:21:25
    Author     : Veron
--%>
...
<html>
    ...
    <br>
    <s:form action="AltaPista" method="post" enctype="multipart/form-data" id="formulario">
        <center><legend style="font-size: 30px;"><b>Datos de la pista</b></legend></center>
            <s:textfield id="campoForm" placeholder="Numero" name="pist.numero" required="required"/>
            <s:textfield id="campoForm1" placeholder="Suelo" name="pist.suelo" required="required"/>
            <s:file id="campoForm2" placeholder="Imagen" name="fileUpload" label="Imagen" required="required"/>
