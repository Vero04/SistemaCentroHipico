<%-- 
    ...
    Created on : 12-jul-2018, 13:38:22
    Author     : Veron
--%>
...
<html>
    ...
    <br><br>
    <s:form action="EditarClase" method="post" id="formulario">
        <s:iterator value="clas">
            <center><legend style="font-size: 30px;"><b>Datos de la clase</b></legend></center>
            <label for="cod" style="font-size: 17px">Codigo</label>
            <input id="campoForm" name="clas.id.cod" readonly="readonly" value="<s:property value="id.cod"/>"/><br>
            <label for="disciplina" style="font-size: 17px">Disciplina</label>
            <input id="campoForm1" type="text" size="25" maxlength="50" readonly="readonly" value="<s:property value="disciplina"/>"/><br>
            <select id="campoForm2" name="clas.disciplina" required>
                <option value="Doma Clasica" selected>Doma Clasica</option> 
            ...
            <label for="diaSemana" style="font-size: 17px">Dia de la semana</label>
            <input id="campoForm3" name="clas.id.diaSemana" readonly="readonly" value="<s:property value="id.diaSemana"/>"/><br>
            <label for="hora" style="font-size: 17px">Hora</label>
            <input id="campoForm4" name="clas.id.hora" type="text" readonly="readonly" value="<s:property value="id.hora"/>"/><br>
            <label for="pista" style="font-size: 17px">Pista</label>
            <input id="campoForm5" name="clas.pista" type="text" size="35" maxlength="100" value="<s:property value="pista"/>" required/><br>
            <label for="profesor" style="font-size: 17px">Profesor</label>
            <input id="campoForm6" name="clas.profesor" type="text" value="<s:property value="profesor"/>" required/> <br>
