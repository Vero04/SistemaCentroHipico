<%-- 
    Document   : ComprobarDNIServicios
    Created on : 23-jul-2018, 16:29:35
    Author     : Veron
--%>
...
<html>
    ...
    <center>    <s:iterator value="cli">
        ...
        <center><div style="width: 250px">
                <center><div style="width: 30%; float: left;"><b><a href="<s:url action="MostrarServiciosReservadosCliente"/>?servCli.id.cliente=<s:property value="id.dni"/>"><img src="Images/aceptar.png" alt="nuevo" width="80" height="80"></a></b></div></center>
                <center><div style="width: 30%; float: right;"><b><a href="<s:url action="Servicios"/>"><img src="Images/cancelar.png" alt="nuevo" width="80" height="80"></a></b></div></center>
            </div></center> 
        </s:iterator> 
