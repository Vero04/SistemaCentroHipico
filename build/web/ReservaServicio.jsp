<%-- 
    ...
    Created on : 22-jul-2018, 17:46:06
    Author     : Veron
--%>
...
<html>
    ...
    <%}%><br>
    <s:form action="AltaReservaServicio" method="post" id="formulario">
        <s:iterator value="servi">
            <center><legend style="font-size: 30px;"><b>Datos de la reserva</b></legend></center>
            <label for="cod" style="font-size: 17px">Servicio</label>
            <input id="campoForm" name="reservServ.id.servicio" readonly="readonly" value="<s:property value="cod"/>" required/><br>
            <label for="Fecha" style="font-size: 17px">Fecha</label><br>
            <input id="datepicker" type="text" name="reservServ.id.fecha" required/><br>
            <label for="DNI" style="font-size: 17px">DNI del cliente</label>
            <input id="campoForm3" type="text" name="reservServ.id.cliente" required/><br>
