<%-- 
    Document   : Clientes
    Created on : 12-jul-2018, 22:41:14
    Author     : Veron
--%>
...
<html>
    ...
    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <center><h4><b>Clientes</b></h4></center>
        <thead>
            <tr>
...
<tbody>
    <s:iterator value="Usuario">
        <tr>
            <td><s:property value="id.usuario"/></td>
            <td><s:property value="id.password"/></td>
            <td><s:property value="id.dni"/></td>
            ...
            <td>Eliminar
                <a href="<s:url action="BorrarCliente"/>?cli.id.dni=<s:property value="id.dni"/>"><img src="Images/Borrar.png" alt="portada" width="40" height="40"></a>             
        </tr>
    </s:iterator>
</tbody>
</table>
