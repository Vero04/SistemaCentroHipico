<%-- 
    Document   : GestionTrabajadores
    Created on : 25-jun-2018, 14:12:17
    Author     : Veron
--%>
...
<html>
    ...
    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <center><h4><b>Trabajadores</b></h4></center>
        <thead>
            <tr>
...
<th><center>TipoTrabajador</center></th>
...
<tbody>
    <s:iterator value="Trabajador">
        <tr>
            ...
            <td><s:property value="tipoTrabajador"/></td>
            <td><s:property value="salario"/></td>
            <td><s:property value="telefono"/></td>
            <td>Eliminar
                <a href="<s:url action="BorrarTrabajador"/>?trabaj.dni=<s:property value="dni"/>"><img src="Images/Borrar.png" alt="portada" width="40" height="40"></a>  
                <br>Modificar
                <a href="<s:url action="MostrarEditarTrabajador"/>?trabaj.dni=<s:property value="dni"/>"><img src="Images/Modificar.png" alt="portada" width="40" height="40"></a></td> 
        </tr>
    </s:iterator>
</tbody>
</table>
<center><div id="boton">
        <center><b><a href="./RegistroTrabajadores.jsp"><img src="Images/Nuevo.png" alt="nuevo" width="40" height="40"><br>Nuevo trabajador</a></b></center>
    </div></center>
<div id="footer">
