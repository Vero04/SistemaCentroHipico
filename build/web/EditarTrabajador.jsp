<%-- 
    ...
    Created on : 18-jul-2018, 13:21:19
    Author     : Veron
--%>
...
<html>
    ...
    <br><br>
    <s:form action="EditarTrabajador" method="post" id="formulario" enctype="multipart/form-data">
        <s:iterator value="trabaj">
            <center><legend style="font-size: 30px;"><b>Datos del Trabajador</b></legend></center>
            <label for="cod" style="font-size: 17px">DNI</label>
            <input id="campoForm" name="trabaj.dni" readonly="readonly" value="<s:property value="dni"/>"/><br>
            <label for="nombre" style="font-size: 17px">Nombre</label>
            <input id="campoForm1" name="trabaj.nombre" type="text" size="25" maxlength="50" value="<s:property value="nombre"/>" required/><br>
            <label for="direccion" style="font-size: 17px">Direccion</label>
            <input id="campoForm3" name="trabaj.direccion" value="<s:property value="direccion"/>" required/><br>
            <label for="codPostal" style="font-size: 17px">Codigo Postal</label>
            <input id="campoForm4" name="trabaj.codPostal" type="text" value="<s:property value="codPostal"/>" required/><br>
            <label for="ciudad" style="font-size: 17px">Ciudad</label>
            <input id="campoForm5" name="trabaj.ciudad" type="text" value="<s:property value="ciudad"/>" required/><br>
            <label for="tipoTrabajador" style="font-size: 17px">Tipo de Trabajador</label>
            <input id="campoForm6" readonly="readonly" value="<s:property value="tipoTrabajador"/>"/><br>
            <select id="campoForm7" name="trabaj.tipoTrabajador" required>
                <option value="Profesor" selected>Profesor</option> 
                <option value="Mozo De Establo">Mozo de Establo</option>
                <option value="Encargado de la organizacion">Encargado de la organizacion</option>
            </select>
            <label for="salario" style="font-size: 17px">Salario</label>
            <input id="campoForm8" name="trabaj.salario" type="text" value="<s:property value="salario"/>" required/><br>
            <label for="telefono" style="font-size: 17px">Telefono</label>
            <input id="campoForm9" name="trabaj.telefono" type="text" value="<s:property value="telefono"/>" required/><br>
            <label for="imagen">Imagen</label>
            <input id="campoForm10" name="fileUpload" type="file" value="<s:property value="imagen"/>" required/> <br>
            <input id="enviar" type="submit" name="enviar" value="Enviar" />
        </s:iterator>
    </s:form>
    <br><br><br>
    <center><a href="<s:url action="TrabajadoresDueno"/>"><img src="Images/FlechaAtras.PNG" alt="Atras" width="40" height="40"></a></center>
    <div id="footer">
