<%-- 
    ...
    Created on : 04-jun-2018, 19:39:38
    Author     : Veron
--%>
...
<html>
    ...
    <center><h5><b>Has iniciado sesion como <%= session.getAttribute("usuario")%></b></h5></center>
                <%}%>
    <div id="video">
        <center><h2><b>Su caballo</b></h2></center>
        <video src="Videos/VideoPrueba1.mp4" autoplay loop style="width: 100%; max-height: 600px;"></video>
    </div>
    <div id="footer">
