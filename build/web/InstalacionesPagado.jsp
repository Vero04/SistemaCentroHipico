<%-- 
    Document   : InstalacionesPagado
    Created on : 25-jul-2018, 11:15:13
    Author     : Veron
--%>
...
<html>
    ...
    <%}%><br>
    <center><h4><b>Elija la pista que desea reservar</b></h4></center>
    <div class="row">
        <s:iterator value="Pista">
            <div class="col-lg-4"> <img src="<s:property value="imagen"/>"alt="portada" width="150" height="150"><br><h5><b><s:property value="numero"/></b></h5>
                <a href="<s:url action="ReservarPista"/>?pist.numero=<s:property value="numero"/>"><img src="Images/reservar.png" alt="portada" width="60" height="40"></a></div>
                </s:iterator>
    </div>
    <div id="footer">
