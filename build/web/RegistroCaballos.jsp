<%-- 
    Document   : RegistroCaballos
    Created on : 25-jun-2018, 16:46:19
    Author     : Veron
--%>
...
<html>
    ...
    <s:if test="input">onload="abrir()"</s:if>
    <s:form action="AltaCaballo" method="post" enctype="multipart/form-data" id="formulario">
        <center><legend style="font-size: 30px;"><b>Datos del caballo</b></legend></center>
            <s:textfield id="campoForm" placeholder="Codigo" name="cabal.cod" required="required"/>
            <s:textfield id="campoForm1" placeholder="Nombre" name="cabal.nombre" required="required"/>
            <s:select id="campoForm2" label="Raza" name="cabal.raza"
                      list="{'PRE','Arabe','Frison','Percheron','De milla','Appaloosa'}" required="required"/>
            <s:select id="campoForm3" label="Venta" name="cabal.venta"
                      list="{'Si','No'}" required="required"/>
            <s:textfield id="campoForm4" placeholder="Cuadra" name="cabal.cuadra" required="required"/>
            <s:textfield id="campoForm5" name="cabal.montura" placeholder="Montura" required="required"/>
            <s:textfield id="campoForm6" placeholder="Embocadura" name="cabal.embocadura" required="required"/>
            <s:textfield id="campoForm7" placeholder="Altura" name="cabal.altura" required="required"/>
            <s:textfield id="datepicker" label="Fecha de herraje" name="cabal.herraje" required="required"/>
            <s:textarea id="campoForm9" label="Tratamiento Veterinario" name="cabal.tratamientoVeterinario" required="required"/>
            <s:select id="campoForm3" label="Alquiler" name="cabal.alquiler"
                      list="{'Si','No'}" required="required"/>
            <s:file id="campoForm10" placeholder="Imagen" name="fileUpload" label="Imagen" required="required"/>
