<%-- 
    Document   : CaballosAlquiler
    Created on : 22-jul-2018, 16:44:43
    Author     : Veron
--%>
...
<html>
    ...
    <%}%><br>
    <center><h4>Caballos con posibilidad de alquiler</h4></center>
    <div class="row" style="border: 4px; border-color: #202326;">
        <s:iterator value="Caballo">
            <div class="col-lg-4"><img src="<s:property value="imagen"/>"alt="portada" width="150" height="150"><br><h5><b><s:property value="nombre"/></b></h5>
                <h5><b><s:property value="raza"/></b></h5></div>
            </s:iterator>
    </div>
    <center><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
            <input type="hidden" name="cmd" value="_s-xclick">
            <input type="hidden" name="hosted_button_id" value="NQRQ3PNFFPXMJ">
    ...
    <br>
    <center><div id="boton">
            <center><div style="width: 25%; float: left;"><b><a href="<s:url action="ReservasCaballosCliente"/>?cli.id.usuario=<%= session.getAttribute("usuario")%>"><img src="Images/reservado.png" alt="nuevo" width="40" height="40"><br>Caballos reservados</a></b></div></center>
            <center><div style="width: 25%; float: right;"><b><a href="<s:url action="Caballos"/>"><img src="Images/FlechaAtras.PNG" alt="nuevo" width="40" height="40"></a></b></div></center>
        </div></center>
    <div id="footer">
