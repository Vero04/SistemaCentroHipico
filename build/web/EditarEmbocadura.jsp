<%-- 
    Document   : EditarEmbocadura
    Created on : 12-jul-2018, 13:40:09
    Author     : Veron
--%>
...
<html>
    ...
    <br>
    <s:form action="EditarEmbocadura" method="post" id="formulario">
        <s:iterator value="emb">
            <center><legend style="font-size: 30px;"><b>Datos de la Embocadura</b></legend></center>
            <label for="cod" style="font-size: 17px">Codigo</label>
            <input id="campoForm" name="emb.cod" readonly="readonly" value="<s:property value="cod"/>"/><br>
            <label for="tipoEmbocadura" style="font-size: 17px">Tipo Embocadura</label>
            <input id="campoForm1"readonly="readonly" value="<s:property value="tipoEmbocadura"/>"/><br>
            <select id="campoForm2" name="emb.tipoEmbocadura" required> 
                <option value="Vaquera" selected>Vaquera</option>
                <option value="Inglesa">Inglesa</option>
            </select>
            <label for="tipoBocado" style="font-size: 17px">Tipo Bocado</label>
            <input id="campoForm3" value="<s:property value="tipoBocado"/>" readonly="readonly"/><br>
            <select id="campoForm4" name="emb.tipoBocado" required>
                <option value="Pelham" selected>Pelham</option> 
                <option value="DeOxido">De Oxido</option>
                <option value="DeGoma">De Goma</option>
                <option value="DeHierro">De Hierro</option>
            </select>
            <label for="tipoFilete" style="font-size: 17px">Tipo Filete</label>
            <input id="campoForm5" value="<s:property value="tipoFilete"/>"/><br>
            <select id="campoForm6" name="emb.tipoFilete" required>
                <option value="Dos Anillas" selected>Dos Anillas</option> 
                <option value="Olivas">Olivas</option>
                <option value="Baucher">Baucher</option>
                <option value="Con Palillos">Con Palillos</option>
    ...
    <br><br><br>
    <center><br><a href="<s:url action="Embocaduras"/>"><img src="Images/FlechaAtras.PNG" alt="Atras" width="40" height="40"></a></center> 
    <div id="footer">
