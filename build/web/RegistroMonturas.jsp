<%-- 
    Document   : RegistroMonturas
    Created on : 26-jun-2018, 12:10:00
    Author     : Veron
--%>
...
<html>
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <br>
    <s:form id="formulario" action="AltaMonturas" method="post">
        <center><legend style="font-size: 30px;"><b>Datos de la montura</b></legend></center>
        <s:textfield id="campoForm" name="Mont.cod" placeholder="Codigo" required="required"/>
        <s:select id="campoForm1" name="Mont.estado" label="Estado"
                  list="{'Muy Bueno','Bueno','Regular','Malo','Muy Malo'}" required="required"/>
        <s:select id="campoForm2" name="Mont.tipo" label="Tipo" 
                  list="{'Campera','Vaquera','Occidental','Australiana','Inglesa','De Doma Clasica','De Saltos','De Polo','De Marcha','De Amazona','De Carreras','De Volteo'}" required="required"/>
        <s:select id="campoForm3" name="Mont.color" label="Color"
                  list="{'Marron','Negro','Rojo','Verde','Azul','Amarilla'}" required="required"/>
        <s:submit id="enviar" label="Enviar" value="enviar"/>
    </s:form>              
    <center><a href="<s:url action="Monturas"/>"<img src="Images/FlechaAtras.PNG" alt="Atras" width="40" height="40"></a> </center> &nbsp;&nbsp;&nbsp;&nbsp;   
    <div id="footer">
