<%-- 
    Document   : ReservaPista
    Created on : 12-jul-2018, 17:14:23
    Author     : Veron
--%>
...
<html>
    ...
    <center><h5><b>Has iniciado sesion como <%= session.getAttribute("usuario")%></b></h5></center>
                <%}%>
                <s:form action="AltaReservaPista" method="post" id="formulario">
            ...
            <input id="campoForm" name="reservPist.id.pista" readonly="readonly" value="<s:property value="numero"/>"/><br>
            <label for="Fecha" style="font-size: 17px">Fecha</label><br>
            <input id="datepicker" type="text" name="reservPist.id.fecha"/><br>
            <label for="Hora" style="font-size: 17px">Horas de reserva</label>
            <input id="campoForm2" type="text" name="reservPist.id.horasReserva"/><br>
            <label for="DNI" style="font-size: 17px">DNI del cliente</label>
            <input id="campoForm3" type="text" name="reservPist.id.cliente"/><br>
