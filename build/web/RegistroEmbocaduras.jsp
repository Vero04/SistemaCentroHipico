<%-- 
    Document   : RegistroEmbocaduras
    Created on : 26-jun-2018, 12:36:34
    Author     : Veron
--%>
...
<html>
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <br>
    <s:form id="formulario" action="AltaEmbocaduras" method="post">
        <center><legend style="font-size: 30px;"><b>Datos de la Embocadura</b></legend></center>
        <s:textfield id="campoForm" name="Emb.cod" placeholder="Codigo" required="required"/>
        <s:select id="campoForm1" name="Emb.tipoEmbocadura" label="Tipo Embocadura"
                  list="{'Vaquera','Inglesa'}" required="required"/>
        <s:select id="campoForm2" name="Emb.tipoBocado" label="Tipo Bocado" 
                  list="{'Pelham','De Oxido','De Goma','De Hierro'}" required="required"/>
        <s:select id="campoForm3" name="Emb.tipoFilete" label="Tipo Filete"
                  list="{'Dos anillas','Olivas','Baucher','Con Palillos','Elevador','Pessoa'}" required="required"/>
        <s:submit id="enviar" label="Enviar" value="enviar"/>
    </s:form>      
    <center><a href="<s:url action="Embocaduras"/>"<img src="Images/FlechaAtras.PNG" alt="Atras" width="40" height="40"></a> </center> &nbsp;&nbsp;&nbsp;&nbsp;   
    <div id="footer">
