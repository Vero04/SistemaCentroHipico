<%-- 
    Document   : Empresas
    Created on : 13-jul-2018, 13:20:09
    Author     : Veron
--%>
...
<th><center>Tipo de empresa</center></th>
<th><center>Telefono</center></th>
<th><center>Enlaces</center></th>
</tr>
</thead>
<tbody>
    <s:iterator value="Empresa">
        <tr>
            ...
            <td><s:property value="tipoEmpresa"/></td>
            <td><s:property value="telefono"/></td>
            <td>Eliminar
                <a href="<s:url action="BorrarEmpresa"/>?empres.cod=<s:property value="cod"/>"><img src="Images/Borrar.png" alt="portada" width="40" height="40"></a>  
                <br>Modificar
                <a href="<s:url action="MostrarEditarEmpresa"/>?empres.cod=<s:property value="cod"/>"><img src="Images/Modificar.png" alt="portada" width="40" height="40"></a></td> 
        </tr>
    </s:iterator>
</tbody>
</table>
<center><div id="boton">
        <center><b><a href="./RegistroEmpresas.jsp"><img src="Images/Nuevo.png" alt="nuevo" width="40" height="40"><br>Nueva Empresa</a></b></center>
    </div></center> 
<div id="footer">
