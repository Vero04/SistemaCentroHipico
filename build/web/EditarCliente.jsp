<%-- 
    ...
    Created on : 12-jul-2018, 13:38:58
    Author     : Veron
--%>
...
<html>
    ...
    <center><h5><b>Has iniciado sesion como <%= session.getAttribute("usuario")%></b></h5></center>
                <%}%>
    <s:form action="EditarCliente" method="post" id="formulario">
        <s:iterator value="cli">
            <center><legend style="font-size: 30px;"><b>Sus datos</b></legend></center>
            <label for="cod" style="font-size: 17px">Usuario</label>
            <input id="campoForm" name="cli.id.usuario" readonly="readonly" value="<s:property value="id.usuario"/>"/><br>
            <label for="Contraseña" style="font-size: 17px">Contraseña</label>
            <input id="campoForm1" type="password" name="cli.id.password" size="25" maxlength="50" readonly="readonly" value="<s:property value="id.password"/>" required/><br>
            <label for="DNI" style="font-size: 17px">DNI</label>
            <input id="campoForm3" name="cli.id.dni" readonly="readonly" value="<s:property value="id.dni"/>"/><br>
            <label for="Nombre" style="font-size: 17px">Nombre y apellidos</label>
            <input id="campoForm4" name="cli.nombre" type="text" value="<s:property value="nombre"/>" required/><br>
            <label for="pista" style="font-size: 17px">Direccion</label>
            <input id="campoForm5" name="cli.direccion" type="text" size="35" maxlength="100" value="<s:property value="direccion"/>" required/><br>
            <label for="Codigo Postal" style="font-size: 17px">Codigo Postal</label>
            <input id="campoForm6" name="cli.codPostal" type="text" value="<s:property value="codPostal"/>" required/><br>
            <label for="Ciudad" style="font-size: 17px">Ciudad</label>
            <input id="campoForm7" name="cli.ciudad" type="text" value="<s:property value="ciudad"/>" required/><br>
            <label for="Telefono" style="font-size: 17px">Telefono</label>
            <input id="campoForm8" name="cli.telefono" type="text" value="<s:property value="telefono"/>" required/><br>
            <label for="Sexo" style="font-size: 17px">Sexo</label>
            <input id="campoForm9" type="text" value="<s:property value="sexo"/>" readonly="readonly" /><br>
            <select id="campoForm10" name="cli.sexo" required>
                <option value="Mujer">Mujer</option>
                <option value="Hombre">Hombre</option>
            </select>
            <input id="enviar" type="submit" name="enviar" value="Enviar" />
            <br><br><br>
            <center><div id="boton" style="min-height: 100px">
                    <center><div style="width: 50%; float: left;"><b><a href="./IndexClientes.jsp"><img src="Images/FlechaAtras.PNG" alt="nuevo" width="40" height="40"></a></b></div></center>
                    <center><div style="width: 50%; float: right;"><b><a href="<s:url action="Eliminar Cuenta"/>?cli.id.dni=<s:property value="id.dni"/>"><img src="Images/Borrar.png" alt="Eliminar" width="40" height="40"><br>Eliminar mi cuenta</a></b></div></center>
                </div></center>
            </s:iterator>
        </s:form>
    <div id="footer">
