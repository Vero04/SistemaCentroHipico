<%-- 
    Document   : ComprobarDNIClases
    Created on : 23-jul-2018, 16:28:38
    Author     : Veron
--%>
...
<html>
    ...
    <center>    <s:iterator value="cli">
        ...
        <center><div style="width: 250px">
                <center><div style="width: 30%; float: left;"><b><a href="<s:url action="MostrarClasesReservadasCliente"/>?clasCli.id.asistente=<s:property value="id.dni"/>"><img src="Images/aceptar.png" alt="nuevo" width="80" height="80"></a></b></div></center>
                <center><div style="width: 30%; float: right;"><b><a href="<s:url action="Clases"/>"><img src="Images/cancelar.png" alt="nuevo" width="80" height="80"></a></b></div></center>
            </div></center> 
        </s:iterator>
