<%-- 
    Document   : Instalaciones
    Created on : 20-jul-2018, 17:48:51
    Author     : Veron
--%>
...
<html>
    ...
    <div class="row">
        <s:iterator value="Pista">
            <div class="col-lg-4"> <img src="<s:property value="imagen"/>"alt="portada" width="150" height="150"><br><h5><b><s:property value="numero"/></b></h5>
             <h5><b>Precio: 10€</b></h5><br></div>
            </s:iterator>
    </div>
    <center><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
            <input type="hidden" name="cmd" value="_s-xclick">
            <input type="hidden" name="hosted_button_id" value="PH5V46VEATG28">
    ...
    <br>
    <center><div id="boton">
            <center><b><a href="<s:url action="ReservasPistasCliente"/>?cli.id.usuario=<%= session.getAttribute("usuario")%>"><img src="Images/reservado.png" alt="nuevo" width="40" height="40"><br>Pistas Reservadas</a></b></center>
        </div></center>
    <div id="footer">
