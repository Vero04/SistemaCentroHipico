<%-- 
    ...
    Created on : 12-jul-2018, 13:39:16
    Author     : Veron
--%>
...
<html>
    ...
    <br>
    <s:form action="EditarPista" method="post" id="formulario" enctype="multipart/form-data">
        <s:iterator value="pist">
            <center><legend style="font-size: 30px;"><b>Datos de la Pista</b></legend></center>
            <label for="numero" style="font-size: 17px">Numero</label>
            <input id="campoForm" name="pist.numero" readonly="readonly" value="<s:property value="numero"/>"/><br>
            <label for="suelo" style="font-size: 17px">Suelo</label>
            <input id="campoForm1" name="pist.suelo" type="text" size="25" maxlength="50" value="<s:property value="suelo"/>" required/><br>
    ...
    <br><br><br>
    <center><a href="<s:url action="InstalacionesDueno"/>"><img src="Images/FlechaAtras.PNG" alt="Atras" width="40" height="40"></a></center>
    <div id="footer">
